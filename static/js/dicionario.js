document.addEventListener('DOMContentLoaded', () => {
    ...
    const descriptions = {
        ...
        kanban:'Resumidamente, Kanban é um sistema visual de gestão de fluxo de trabalho que utiliza cartões para representar tarefas em diferentes estágios de um processo. Ele facilita a visualização, controle e otimização do fluxo de trabalho, promovendo eficiência e gestão ágil das atividades.',
